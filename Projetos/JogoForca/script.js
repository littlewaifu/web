let palavras = ["programador", "algoritmo", "javascript", "html", "css", "web", 
"frontend", "backend", "fullstack", "desenvolvimento", "aplicativo", "jogo", "site", "software"];
...
function mensagemFinal(texto)
{
    ...
    let t1 = document.createTextNode(texto);
